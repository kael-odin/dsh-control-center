...
declare module '@deepseek-ai/dsh-typert-protocol' {
  interface TypertRemoteNamespaceMap {
    controlCenterTranslation: {
      start(request: TranslationRequest): Promise<{ ok: true; value: TranslationStartResult } | { ok: false; error: { code: string; message: string; details: object } }>
      get(jobId: string): Promise<{ ok: true; value: TranslationJobView } | { ok: false; error: { code: string; message: string; details: object } }>
