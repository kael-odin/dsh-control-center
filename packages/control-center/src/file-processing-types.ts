...
declare module '@deepseek-ai/dsh-typert-protocol' {
  interface TypertRemoteNamespaceMap {
    controlCenterFileProcessing: {
      ...
      getConfig(): Promise<{ ok: true; value: { defaultDocumentProcessor: FileProcessorId; defaultImageProcessor: FileProcessorId; overrides: Partial<Record<FileProcessorId, FileProcessorOverride>> } } | { ok: false; error: { code: string; message: string; details: object } }>
      ...
      setOverride(processor: FileProcessorId, override: FileProcessorOverride): Promise<{ ok: true; value: { absent: true } } | { ok: false; error: { code: string; message: string; details: object } }>
