...
export const PROVIDER_PRESETS: readonly ProviderPreset[] = [
  // ----- 国内平台 -----
  { id: 'zhipu', name: '智谱开放平台', type: 'openai-compatible', baseURL: 'https://open.bigmodel.cn/api/paas/v4', group: 'domestic' },
  { id: 'deepseek', name: '深度求索', type: 'deepseek', baseURL: 'https://api.deepseek.com/v1', group: 'domestic' },
  { id: 'moonshot', name: '月之暗面', type: 'openai-compatible', baseURL: 'https://api.moonshot.cn/v1', group: 'domestic' },
  { id: 'baichuan', name: '百川', type: 'openai-compatible', baseURL: 'https://api.baichuan-ai.com/v1', group: 'domestic' },
  { id: 'dashscope', name: '阿里云百炼', type: 'openai-compatible', baseURL: 'https://dashscope.aliyuncs.com/compatible-mode/v1', group: 'domestic' },
  { id: 'stepfun', name: '阶跃星辰', type: 'openai-compatible', baseURL: 'https://api.stepfun.com/v1', group: 'domestic' },
  { id: 'doubao', name: '火山引擎', type: 'openai-compatible', baseURL: 'https://ark.cn-beijing.volces.com/api/v3', group: 'domestic' },
  { id: 'minimax', name: 'MiniMax', type: 'openai-compatible', baseURL: 'https://api.minimaxi.com/v1', group: 'domestic' },
  { id: 'minimax-global', name: 'MiniMax 海外版', type: 'openai-compatible', baseURL: 'https://api.minimax.io/v1', group: 'international' },
  { id: 'silicon', name: '硅基流动', type: 'openai-compatible', baseURL: 'https://api.siliconflow.cn/v1', group: 'domestic' },
  ...
  { id: 'lanyun', name: '蓝耘科技', type: 'openai-compatible', baseURL: 'https://maas-api.lanyun.net', group: 'domestic' },
  ...
  { id: 'qiniu', name: '七牛云 AI 推理', type: 'openai-compatible', baseURL: 'https://api.qnaigc.com', group: 'domestic' },
  { id: 'modelscope', name: 'ModelScope 魔搭', type: 'openai-compatible', baseURL: 'https://api-inference.modelscope.cn/v1', group: 'domestic' },
  { id: 'xirang', name: '天翼云息壤', type: 'openai-compatible', baseURL: 'https://wishub-x1.ctyun.cn', group: 'domestic' },
  { id: 'tokenhub', name: 'TokenHub', type: 'openai-compatible', baseURL: 'https://tokenhub.tencentmaas.com/v1', group: 'domestic' },
  { id: 'baidu-cloud', name: '百度云千帆', type: 'openai-compatible', baseURL: 'https://qianfan.baidubce.com/v2', group: 'domestic' },
  { id: 'longcat', name: '龙猫', type: 'openai-compatible', baseURL: 'https://api.longcat.chat', group: 'domestic' },
  ...
  { id: 'github', name: 'GitHub Models', type: 'openai-compatible', baseURL: 'https://models.github.ai/inference', group: 'international' },
  ...
  { id: 'nvidia', name: '英伟达', type: 'openai-compatible', baseURL: 'https://integrate.api.nvidia.com', group: 'international' },
