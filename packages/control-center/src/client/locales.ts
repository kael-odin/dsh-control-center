...
export const en = {
  ...
  modelAdvancedExtra: 'Extra',
  modelPurposeLabel: 'Purpose',
  modelPurposeDialogue: 'Dialogue',
  modelPurposeImageGen: 'Image generation',
  modelPurposeImageEdit: 'Image editing',
  modelProtocolLabel: 'Protocol',
  modelProtocolPlaceholder: 'e.g. openai, anthropic, gemini',
  modelIncrementalLabel: 'Streaming',
  modelPricingLabel: 'Pricing (per 1K tokens)',
  modelPricingCurrency: 'Currency',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvancedExtra: '扩展',
  modelPurposeLabel: '用途',
  modelPurposeDialogue: '对话',
  modelPurposeImageGen: '图像生成',
  modelPurposeImageEdit: '图像编辑',
  modelProtocolLabel: '协议',
  modelProtocolPlaceholder: '例如 openai、anthropic、gemini',
  modelIncrementalLabel: '增量输出',
  modelPricingLabel: '价格（每千 token）',
  modelPricingCurrency: '币种',
