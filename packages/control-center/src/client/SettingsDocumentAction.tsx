...
export type SettingsDocumentActionProps =
  PropsRuntime<'settings.action'> & PropsLocale<'control-center'> & SettingsDocumentActionInjected
...
export function SettingsDocumentAction({ controller, useSnapshot, t }: SettingsDocumentActionProps): ReactNode {
  ...
  return (
    <div className={css.action}>
      {state.error === null ? null : <span className={css.error} role="alert">{t('openDocumentError')}</span>}
      <Button
        variant="outline"
        size="sm"
