...
declare module '@deepseek-ai/dsh-typert-protocol' {
  interface TypertRemoteNamespaceMap {
    controlCenterUsage: {
      ...
      timeline(request: UsageTimelineRequest): Promise<{ ok: true; value: UsageTimelinePoint[] } | { ok: false; error: { code: string; message: string; details: object } }>
      stats(request: UsageStatsRequest): Promise<{ ok: true; value: UsageStats } | { ok: false; error: { code: string; message: string; details: object } }>
      entries(request: UsageEntriesRequest): Promise<{ ok: true; value: UsageEntriesPage } | { ok: false; error: { code: string; message: string; details: object } }>
    }
  }
}
