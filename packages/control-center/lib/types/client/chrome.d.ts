...
export type TriggerContentProps = PropsRuntime<'settings.trigger'> & PropsLocale<'control-center'>;
/** Header content props: the standard locale seat only. */
export type HeaderContentProps = PropsRuntime<'settings.header'> & PropsLocale<'control-center'>;
/**
...
export type CloseLabelProps = PropsRuntime<'settings.close'> & PropsLocale<'control-center'>;
/**
