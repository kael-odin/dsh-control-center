...
declare module '@deepseek-ai/dsh-typert-protocol' {
    interface TypertRemoteNamespaceMap {
        controlCenterPainting: {
            ...
            start(request: PaintingRequest): Promise<{
                ok: true;
                value: PaintingStartResult;
            } | {
                ok: false;
                error: {
                    code: string;
            ...
            deleteHistory(id: PaintingHistoryId): Promise<{
                ok: true;
                value: {
                    absent: true;
                };
...
//# sourceMappingURL=painting-types.d.ts.map