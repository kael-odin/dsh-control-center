...
export type FileProcessorStatusCode = 'ready' | 'needs-credential' | 'needs-runtime' | 'unsupported-platform' | 'unavailable';
...
declare module '@deepseek-ai/dsh-typert-protocol' {
    interface TypertRemoteNamespaceMap {
        controlCenterFileProcessing: {
            ...
            getConfig(): Promise<{
                ok: true;
                value: FileProcessingConfigView;
            } | {
                ok: false;
                error: {
                    code: string;
            ...
            getTaskResult(taskId: string): Promise<{
                ok: true;
                value: FileProcessingTaskResult;
            } | {
                ok: false;
                error: {
                    code: string;
