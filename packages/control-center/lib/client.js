window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css$6 = ".uIwUgq_triggerLabel{white-space:nowrap;overflow:hidden}";
		const tagId$6 = "@dsh-control-center/control-center/chrome.module.css";
		...
		*/
		...
		const css$5 = ".DFoDHW_section{flex-direction:column;width:100%;display:flex}.DFoDHW_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		const tagId$5 = "@dsh-control-center/control-center/GeneralSection.module.css";
		...
		*/
		...
		const css$4 = ".SgSrUG_action{align-items:center;gap:8px;min-width:0;display:flex}.SgSrUG_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
		const tagId$4 = "@dsh-control-center/control-center/SettingsDocumentAction.module.css";
		...
		*/
		...
		const css$2 = ".C_CJ_a_dialog{width:min(600px,100%);padding:0}.C_CJ_a_content{box-sizing:border-box;flex-direction:column;max-height:calc(100vh - 48px);padding:28px;display:flex;overflow-y:auto}.C_CJ_a_title{color:var(--dsw-alias-label-primary);outline:none;margin:0;font-size:20px;font-weight:500;line-height:28px}.C_CJ_a_body{margin-top:20px}@media (width<=560px){.C_CJ_a_content{padding:24px}}";
		const tagId$2 = "@dsh-control-center/control-center/OnboardingModal.module.css";
		...
		*/
		...
		const css$1 = ".oxcHWa_description{color:var(--dsw-alias-label-secondary);margin:0;font-size:14px;line-height:24px}.oxcHWa_editor{margin-top:24px}@media (width<=560px){.oxcHWa_editor{margin-top:20px}}";
		const tagId$1 = "@dsh-control-center/control-center/DeepSeekOnboardingDialog.module.css";
