...
- The initial parity baseline is the local `D:\Github_Open\cherry-studio` checkout at commit `13687df`, whose application version is `2.0.7`. Later upstream synchronization is deliberate work, not an implicit moving target.
